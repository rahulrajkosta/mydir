...
class Category_Model extends Model
{
    ...
    {
        return Category_Model::where("status","!=","D")->get();
    }
    ...
    public function store($input){
       ...
       return Category_Model::insertGetId($input);
	...
	{
        return Category_Model::where("status","!=","D")->find($id);
    }
    ...
    { 
       return Category_Model::where('id', $request->id)->update($input);
